...
const PortfolioAdd=() =>{
    ...
    const BASE_URL="http://localhost:1243/portfolio/addPortfolio"
            ...
            <div className="containerf">
                ...
                <form action="#">
                    <div class="portfolio-details">
                            ...
                            <select className="selections" style={{width: "78%","height":"50%"}} value={urlValue} onChange={changeUrlValue}>
                                                 <option>---Choose Theme---</option>
                                                 {
                                                    themeName ? (themeName.map((data, key) => (
                                                         <option value={data.theme.themeName}> {data.theme.themeName}</option>
                                                     ))) : (<>Loading...</>)
                                                 }
                        ...
                        <div>
                            <button className="view" onClick={()=>navigate('/theme',{state:{data:urlValue}})}>View Theme</button>
                        </div>
